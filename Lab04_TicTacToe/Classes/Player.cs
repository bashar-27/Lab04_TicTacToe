   ...
   public class Player
    {
		...
		public Position GetPosition(Board board)
		{
			...
			while (desiredCoordinate is null)
			{
				if (Name.Equals("Computer"))
				{
					...
					int compPostion = random.Next(9) + 1;
					desiredCoordinate = PositionForNumber(compPostion);
					...
					Int32.TryParse(Console.ReadLine(), out int userPos);
					desiredCoordinate = PositionForNumber(userPos);
				}
			}
		...
		public void TakeTurn(Board board)
		{
			...
			while (flag)
			{
				...
				{
					Console.WriteLine("Position taken!Enter a correct position");
				}
			}
		}
	}
